...
def main():
    ...
    # scutil prints `domain : erp.corp` (colon + padding) inside a resolver
    # block; match whitespace-tolerantly and keep an excerpt for evidence
    ...
    check(
        "scutil --dns carries the scoped resolver (OS routing truth)",
        bool(dom and ns),
        excerpt,
    )
